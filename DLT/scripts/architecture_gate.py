...
def main() -> int:
    ...
    checks["service_uses_engine"]="from glp.engine import" in service or "from .engine import" in service
    checks["service_uses_storage"]="from glp.storage import" in service or "from .storage import" in service
    checks["service_uses_evidence"]="from glp.evidence import" in service or "from .evidence import" in service
